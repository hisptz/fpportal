...
angular.module("hmisPortal")
    ...
    .controller("stockoutCtrl",function ($rootScope,$scope,$http,$location,$timeout,olData,olHelpers,shared,portalService,FPManager,$location) {
            ...
            }else
            {
                $.post( portalService.base + "dhis-web-commons-security/login.action?authOnly=true", {
                    ...
                    $http.get(url).success(function (district) {
                        ...
                        var orgUnits = [{id: $scope.districtUid, name: $scope.districtName}];
