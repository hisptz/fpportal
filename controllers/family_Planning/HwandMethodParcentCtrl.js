        ...
        $scope.getSelectedValues = function(){
            ...
            }else
            {
                ...
                $scope.dispensaryObject = {
                    ...
                    denominator:'Total number of dispensaries that are: <br>(i) eligible to provide FP services AND  <br>(ii) have one or more healthworkers that have achieved training competency  in the selected FP method/s (short-acting, implants, IUCDs, minilap, NSV) In the selected geography for each month in the indicated 12 month period.',
                    data_source:'TrainTracker and DHIS-2 FP reporting Tool'
                };
                ...
                $scope.healtyCenterObject = {
                    ...
                    denominator:'Total number of health centres that are: <br>(i) eligible to provide FP services AND  <br>(ii) have one or more healthworkers that have achieved training competency  in the selected FP method/s (short-acting, implants, IUCDs, minilap, NSV) In the selected geography for each month in the indicated 12 month period.',
                    data_source:'TrainTracker and DHIS-2 FP reporting Tool'
                };
