...
angular.module("hmisPortal")
    ...
    .controller("monthlyReportsCtrl",function ($rootScope,$scope,$http,$location,$timeout,FPManager,olData,olHelpers,shared,portalService) {
